...
public class UserCapController implements Initializable {
            ...
            protected void updateItem(Double price, boolean empty) {
                ...
                if (empty || price == null) {
                    ...
                    if (product != null) {
                        ...
                        // Save spinner for later retrieval
    ...
    private void loadCapProducts() {
        productList.clear();
        String query = "SELECT * FROM product WHERE category_id = 'C002 - CAP'"; // Assuming cap category ID
        try (Connection conn = DatabaseHandler.getDBConnection();
    ...
    // Remove the old updateCapProductQuantityInDB method as it's no longer needed
}