...
public class UserShirtController {
    ...
    private void handleAddToCart() {
        ...
        if (selectedProduct != null) {
            ...
            // Quantity from spinner or product's quantity property
            int quantity = selectedProduct.getQuantity() > 0 ? selectedProduct.getQuantity() : 1;
            cartItem.setQuantity(quantity);

            // Add to cart via static method in UserCartController
