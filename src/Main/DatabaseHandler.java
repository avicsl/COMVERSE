...
public List<CartItem> getCartItemsByStudentNumber(String studentNumber) {
    List<CartItem> items = new ArrayList<>();
    String query = "SELECT * FROM cart WHERE student_number = ?";
    ...
    try (Connection conn = getDBConnection();
        ...
        while (rs.next()) {
            CartItem item = new CartItem(
                rs.getString("product_id"),  // Adjust as needed if you want full product name
...
public boolean upsertCartItem(CartItem item, String studentNumber) {
    String query = """
        INSERT INTO cart (product_id, student_number, image_url, quantity, amount)
        VALUES (?, ?, ?, ?, ?)
