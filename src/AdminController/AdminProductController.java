...
public class AdminProductController {
    ...
    @FXML
    private TextField pURLTextFIeld;  // fixed naming
 
    @FXML
    private TextField productNameTextField;
 
    @FXML
    private TextField amountTextFIeld;  // fixed naming
    ...
    public void initialize() {
        ...
        // Initialize Spinner: min 1, max 100, initial 1
        ...
        // Display image in pURLcol as ImageView
        pURLcol.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(String imageUrl, boolean empty) {
                ...
                if (empty || imageUrl == null || imageUrl.isEmpty()) {
                    ...
                    try {
                        Image img = new Image(imageUrl, 60, 60, true, true);
    ...
    selected.setProductName(productNameTextField.getText().trim());
    selected.setImageUrl(pURLTextFIeld.getText().trim());
    selected.setAmount(Double.parseDouble(amountTextFIeld.getText().trim()));
